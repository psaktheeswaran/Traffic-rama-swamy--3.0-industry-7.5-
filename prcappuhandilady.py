...
# Initialize variables for counting and tracking line
counters = {class_name: 0 for class_name in classes}
start_time = datetime.datetime.now()
tracking_line_position = int(frame_width / 2)  # Adjust this according to the desired position of the line
...
while True:
    ...
    for i in indices:
        ...
        if counters[class_name] >= thresholds[class_name]:
            # Check if the object crossed the tracking line
            if x + width < tracking_line_position:
    ...
    # Draw tracking line on the frame
    cv2.line(frame, (tracking_line_position, 0), (tracking_line_position, frame_height), (255, 0, 0), 2)
