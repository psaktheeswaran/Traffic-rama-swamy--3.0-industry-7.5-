...
while True:
    ...
    # Check if cat is not detected
    if 0 not in class_ids:
        # Detect person and dog
        person_index = [i for i, class_id in enumerate(class_ids) if class_id == 15]
        dog_index = [i for i, class_id in enumerate(class_ids) if class_id == 16]
